            ...
            skillCategories.forEach((category, categoryIndex) => {
              category.skills.forEach((skill, skillIndex) => {
                setTimeout(() => {
                  setAnimatedSkills(
                    (prev) =>
                      new Set([...prev, `${categoryIndex}-${skillIndex}`])
                  );
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A comprehensive skill set combining traditional finance expertise
                            ...
                            style={{
                              ...
                              background:
                                category.color === "primary"
                                  ...
                                  ? "linear-gradient(90deg, hsl(var(--success)), hsl(var(--success-glow)))"
        ...
        >
          <div className="text-center glass-card rounded-xl p-6 hover:shadow-elevated transition-all duration-300 group">
            ...
            <p className="text-muted-foreground text-sm">
              Successfully integrated AI tools for financial analysis and
              business automation
            </p>
          </div>
          ...
          <div className="text-center glass-card rounded-xl p-6 hover:shadow-elevated transition-all duration-300 group">
            ...
            <p className="text-muted-foreground text-sm">
              Advanced data visualization and analysis capabilities for
          ...
          <div className="text-center glass-card rounded-xl p-6 hover:shadow-elevated transition-all duration-300 group">
            ...
            <p className="text-muted-foreground text-sm">
              Extensive experience across multiple countries with deep cultural
              understanding
            </p>
          </div>
        </div>
