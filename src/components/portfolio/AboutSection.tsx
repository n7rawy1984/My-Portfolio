...
const achievements = [
  {
    ...
    description:
      "Reduced monthly closing time by 40% through workflow improvements",
    stat: "40%",
  },
  {
    icon: Award,
...
export const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 relative pb-5 pt-5 min-h-screen relative flex items-center justify-center overflow-x-hidden"
    >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  ...
                  <span className="text-primary font-semibold">15+ years</span>{" "}
                  of experience bridging the gap between traditional finance and
                  modern technology.
                </p>
                ...
                <p>
                  ...
                  , operations management, and digital transformation. Fluent in
                  both
                  <span className="text-primary"> English and Arabic</span>,
                  with proven ability to optimize processes and drive business
                  improvements across multicultural environments.
                </p>

                <p>
                  Currently expanding capabilities into{" "}
                  <span className="text-success font-semibold">
                    data analysis and web development
                  </span>
                  , combining traditional business acumen with cutting-edge
                  digital skills.
                </p>
              </div>
            </div>
