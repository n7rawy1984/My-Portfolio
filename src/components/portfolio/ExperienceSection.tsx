...
const experiences = [
  {
    title: "Freelance Business & Digital Marketing Consultant",
    company: "Self-Employed",
    location: "Alexandria, Egypt",
    period: "2024 - Present",
    type: "Current",
    achievements: [
      "Transitioned from accounting consultancy to digital marketing and web development",
      "Designed and launched marketing campaigns for small businesses across Meta platforms (Facebook, Instagram, WhatsApp)",
      "Built responsive landing pages and brand websites using HTML, CSS, JavaScript, React, and Tailwind CSS",
      "Created visual branding packages including logos, social media designs, and ad creatives",
      "Wrote high-converting marketing content tailored to target audiences",
      "Managed client projects end-to-end as a freelance consultant, combining technical and strategic expertise",
    ],
  },
  {
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            15+ years of progressive experience across accounting, operations,
